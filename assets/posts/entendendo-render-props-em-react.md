...
Note que, passando o render em formato de função, temos o acesso aos parâmetros contidos nessa função, ou seja, conseguimos assim fazer com que um componente se comunique com o outro.
